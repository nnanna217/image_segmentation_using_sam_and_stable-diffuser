...
with gr.Blocks() as demo:
    ...
    def generate_mask(image, evt: gr.SelectData):
        ...
        input_points = np.array(selected_pixels)  # x,y coordinates of selected pixels
        input_labels = np.ones(input_points.shape[0])
        # Sam predictor - # Returns a mask in shape of (n, size, size)
